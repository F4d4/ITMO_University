...
- "Планшетный" — для устройств, ширина экрана которых равна или превышает 834, но меньше 1057 пикселей.
...
- Набор полей ввода для задания координат точки и радиуса области в соответствии с вариантом задания:  
  ...
  Если поле ввода допускает ввод заведомо некорректных данных (например, букв в координатах точки или отрицательного радиуса), то приложение должно осуществлять их валидацию.
...
<img width="531" height="511" alt="Снимок экрана 2026-04-27 184744" src="https://github.com/user-attachments/assets/1e7a0250-a130-4333-a3c6-a13164000558" />
