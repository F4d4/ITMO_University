...
- Набор компонентов для задания координат точки и радиуса области в соответствии с вариантом задания.  
  ...
  Если компонент допускает ввод заведомо некорректных данных (например, букв в координатах точки или отрицательного радиуса), то приложение должно осуществлять их валидацию.
...
<img width="1047" height="711" alt="Снимок экрана 2026-04-27 184152" src="https://github.com/user-attachments/assets/98e2347c-8ed2-441f-ac5a-5ed97cf54969" />
