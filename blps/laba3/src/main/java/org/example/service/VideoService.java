...
import org.example.messaging.PublicationTaskMessage;
import org.example.messaging.StompMessageSender;
...
public class VideoService {
    ...
    public VideoResponse submitForPublication(Long videoId, Long userId, VideoPublishRequest request) {
        ...
        PublicationTaskMessage taskMessage = new PublicationTaskMessage(videoId, video.getTitle(), nodeId);
        stompMessageSender.sendPublicationTask(taskMessage);
